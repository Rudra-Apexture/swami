...
// import Link from 'next/link';
// import { Tooltip } from 'react-tooltip';
// import RoomCarousel from '../../(public)/components/RoomCarousel';  // Corrected path if necessary
// import slugify from 'slugify';
// import { DatePickerWithRange } from "../../components/DatePickerWithRange.js";  //Corrected path
// import Dropdown from '@/app/(public)/components/Dropdown'; // Corrected path
...
//     const [rooms, setRooms] = useState(1); // Number of rooms
//     const [guests, setGuests] = useState([
//         { adults: 2, children: 0, id: 1 }, // Added a unique ID
//     ]);
//     const [isDropdownOpen, setIsDropdownOpen] = useState(false);
//     const dropdownRef = useRef(null);

//     // --- Data (can be moved outside the component if it's static) ---
//     const roomsData = [
//         {
//             id: 1,
//             name: "Economy GowSeva",
...
//     // --- Initial State for selectedRoom ---
//     const [selectedRoom, setSelectedRoom] = useState(roomOptions[0]);

//     // --- Dropdown and Date Handlers ---
...
//             const newGuests = [...prevGuests];
//             while (newGuests.length < newRoomCount) {
//                 newGuests.push({ adults: 2, children: 0, id: Date.now() + newGuests.length }); // Unique ID
//             }
//             newGuests.length = newRoomCount; // Truncate
//             return newGuests;
//         });
//     };
...
//     // --- Fetch Room Data and Conditional Rendering INSIDE useEffect ---
//     useEffect(() => {
//         const fetchData = async () => {
//             setLoading(true);
...
//                     room => slugify(room.name, { lower: true }) === slug
//                 );
//                 setRoom(foundRoom);  // Set room state
//             }
//             setLoading(false);
//         };
...
//     }, [slug, roomsData]); // Add roomsData as a dependency


//     // --- Loading and Not Found ---  These MUST be OUTSIDE any conditional rendering
//     if (loading) {
//         return (
//             <div className="container mx-auto p-4 min-h-screen flex items-center justify-center">
//                 <div className="text-center">
...
//                                                             <Dropdown
//                                                                 options={adultOptions}
//                                                                 value={adultOptions.find(
//                                                                     (opt) => opt.value === guest.adults
//                                                                 )}
//                                                                 onChange={(adultOption) =>
//                                                                     handleGuestChange(
//                                                                         roomIndex,
//                                                                         "adults",
//                                                                         adultOption
...
//                                                                     (opt) => opt.value === guest.children
//                                                                 )}
//                                                                 onChange={(childOption) =>
//                                                                     handleGuestChange(
//                                                                         roomIndex,
//                                                                         "children",
//                                                                         childOption
