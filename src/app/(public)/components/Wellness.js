...
//     return (
//         <>
//             <div className="bg-orange-100/50 py-12 text-center">
//                 {/* Logo */}
...
//                     <p className='text-gray-500 font-normal text-xl mt-4 max-w-4xl'>
...
//                         <div key={index} className="w-80 rounded-lg shadow-md">
...
//                             </div>
//                             <div className="p-4">
//                                 <h3 className="text-xl font-semibold text-orange-600 mb-2">{card.title}</h3>
