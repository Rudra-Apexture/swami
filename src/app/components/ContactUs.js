            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-0 gap-8">
                ...
                <div className="px-4">
                    ...
                    <div className='flex items-center gap-4 mb-5'>
                        ...
                        <a href='mailto:swaminarayantb@gmail.com' className='text-gray-700 text-base lg:text-lg'>
                            swaminarayantb@gmail.com
                        </a>
                    </div>
                    <div className='flex items-center gap-4 mb-5'>
                        <FaPhoneAlt className='size-5 text-main' />
                        <a href='tel:+1800 900 1248' className='text-gray-700 text-base lg:text-lg'>
                            +1800 900 1248
                        </a>
                    </div>
                    <div className="flex items-center gap-3">
